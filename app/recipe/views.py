...
"""
# stuff needed for handling custom  documentation 
...
from rest_framework import (
    viewsets,
    mixins,
    status,     # to check status responses
)
...
# decorator to add additional docu to the list endpoint
@extend_schema_view(
    list=extend_schema(
        parameters=[
            OpenApiParameter(
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    # override to filter objs linked to auth user and tags/ingr 
    ...
    #actions: add additional functionality to default viewsets. ModelViewset
    # provides multiple builtin actions
    ...
    # custom action ddefinition. detail: apply only to detail endpoint
